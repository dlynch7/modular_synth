...
scaled_V_per_cent = V_per_cent*(ADC_input_range_V/pitch_CV_range)
ADC_resolution_bits = 16.0
ADC_resolution_V_per_count = ADC_input_range_V/(2**ADC_resolution_bits)
print("\tADC: %d bits, %5.3f V input range:" % (ADC_resolution_bits, ADC_input_range_V))
ADC_resolution_cents = ADC_resolution_V_per_count/scaled_V_per_cent
print("\t\t%8.5f V/count = %8.5f cents/count" % (ADC_resolution_V_per_count,ADC_resolution_cents))
